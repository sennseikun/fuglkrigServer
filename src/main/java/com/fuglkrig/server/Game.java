...
public class Game extends Thread {
    ...
    public void initFugles(){
        try {
            fugl_image = ImageIO.read(new File("com/fuglkrig/server/resources/bird.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void updateFugles(){
        ...
        for(Player p: players){
            ...
            Fugl f = new Fugl(x,y,fugl_height,fugl_width, "com/fuglkrig/server/resources/bird.png");
